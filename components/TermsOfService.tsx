...
const TermsOfService: React.FC<Props> = ({ onBack }) => {
    return (
        <div className="min-h-screen bg-[#420b24] text-white pt-24 px-4 pb-12">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="prose prose-invert prose-blue max-w-none space-y-8 text-white/80">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-4">4. Intellectual Property (Open Source)</h2>
                        <p>
