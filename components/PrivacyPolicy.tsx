        ...
        <div className="min-h-screen bg-[#F8FAFA] pt-24 px-4 pb-12">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="prose prose-slate max-w-none space-y-8 text-slate-700">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-slate-900 mb-4">5. Google User Data</h2>
                        <p>
                            Our use and transfer to any other app of information received from Google APIs will adhere to the
                            <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:underline"> Google API Services User Data Policy</a>,
                            including the Limited Use requirements.
                        </p>
                    </section>

                    <section>
                        <h2 className="text-2xl font-bold text-slate-900 mb-4">6. Open Source</h2>
                        <p>
